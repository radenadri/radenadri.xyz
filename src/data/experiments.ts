export default [{
  ...
  icon: '📱',
  title: 'Gemini Chat',
  description: 'Gemini Chat is a chatbot that i build using Flutter and Gemini API. It is a proof of concept about how talk with LLM using Flutter.',
  ...
  link: 'https://minecraft-clone.radenadri.xyz'
}, {
  icon: '🔴',
  title: 'Pokedex',
  ...
  link: 'https://pokedex.radenadri.xyz'
}]
