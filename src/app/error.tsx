  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[var(--space-void)] text-[var(--space-star-white)] px-6 py-20 sm:px-10">
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 30% 0%, rgba(255,42,0,0.25), transparent 55%), radial-gradient(circle at 80% 20%, rgba(0,68,255,0.12), transparent 45%)',
        }}
        aria-hidden
      />
      <div className="relative mx-auto flex max-w-4xl flex-col gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="max-w-2xl text-base text-white/80">
            Something went wrong. I already logged the telemetry. You can
            attempt a reload or head back to the home page.
          </p>
        </div>
        <div className="grid gap-4 text-sm sm:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            <p className="text-white/60">Suggested actions</p>
            <ul className="mt-3 space-y-2 text-white/80">
              <li>- Try reloading this page.</li>
              <li>- If it keeps failing, send over a bug report.</li>
            </ul>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            <p className="text-white/60">Error digest</p>
            <p className="mt-3 text-2xl font-semibold">
              {error.digest ?? 'N/A'}
            </p>
            <p className="text-white/70">
              Reference when contacting mission control.
            </p>
          </div>
        </div>
